...
public class DrinksAndFries extends JPanel {
    ...
    public DrinksAndFries(List<Integer> passedSelectedMenuIDs, JPanel passedOrderPanel, List<Integer> passedToBeDeleted) {
        ...
        JLabel label = new JLabel("DrinksAndFries");
        ...
        for (int i = 0; i < numberOfItems; i++) {
            if((menuItemIDs[i] >= 500) && (menuItemIDs[i] <= 599)) {
                String name = names[i];
    ...
    private class ButtonClickListener implements ActionListener {
        private DrinksAndFries drinksAndFries;
        private String buttonName;

        public ButtonClickListener(DrinksAndFries drinksAndFries, String buttonName) {
            this.drinksAndFries = drinksAndFries;
